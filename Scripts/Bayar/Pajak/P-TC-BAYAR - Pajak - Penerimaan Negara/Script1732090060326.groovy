...
Mobile.setText(findTestObject('Object Repository/Bayar/Pajak-MPN/Penerimaan Negara - MPN/08. EditText-Set Kode Billing'), '119100190012672', 0)
...
Mobile.verifyElementText(findTestObject('Object Repository/Bayar/Pajak-MPN/Penerimaan Negara - MPN/12. TextView-Rp. 9.684'), 
	'Rp. 9.684')

Mobile.verifyElementText(findTestObject('Object Repository/Bayar/Pajak-MPN/Penerimaan Negara - MPN/13. TextView-Adm Rp. 0'), 
	'Rp. 0')

Mobile.verifyElementText(findTestObject('Object Repository/Bayar/Pajak-MPN/Penerimaan Negara - MPN/14. TextView-Total Rp. 9.684'), 
	'Rp. 9.684')
...
Mobile.verifyElementText(findTestObject('Object Repository/Bayar/Pajak-MPN/Penerimaan Negara - MPN/19. TextView-Rp. 9.684'), 
	'Rp. 9.684')

Mobile.verifyElementText(findTestObject('Object Repository/Bayar/Pajak-MPN/Penerimaan Negara - MPN/20. TextView-Nominal Rp. 9.684'), 
	'RRp. 9.684')

Mobile.verifyElementText(findTestObject('Object Repository/Bayar/Pajak-MPN/Penerimaan Negara - MPN/21. TextView-Adm Rp. 0'), 
	'Rp. 0')

Mobile.verifyElementText(findTestObject('Object Repository/Bayar/Pajak-MPN/Penerimaan Negara - MPN/22. TextView-Total Rp. 9.684'), 
	'RRp. 9.684')
