...
Mobile.tap(findTestObject('Object Repository/QRIS/Upload QRIS - Albums/01. ViewGroup-QRIS'), 0)
...
Mobile.tap(findTestObject('Object Repository/QRIS/Upload QRIS - Albums/03. ImageView-Wa Albums'), 0)

Mobile.delay(2)
Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshot\\P-TC-QRIS - Upload QRIS - Albums\\05.png')

Mobile.tap(findTestObject('Object Repository/QRIS/Upload QRIS - Albums/04. ImageView-QR'), 0)
...
Mobile.tap(findTestObject('Object Repository/QRIS/Upload QRIS - Albums/31. PathView-Close Button'), 0)
