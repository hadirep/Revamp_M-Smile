...
Mobile.tap(findTestObject('01.New Update Script Repo/Top Up Bayar - Ewallet/03. Gopay'), 0)
...
Mobile.tap(findTestObject('Topup/E-Wallet/Gopay/android.view.ViewGroup'), 0)
