...
Mobile.delay(1)
Mobile.takeScreenshot('C:\\Users\\H23070017\\Katalon Studio\\Msmile Revamp\\Screenshot\\N-TC-TOPUP - Paket Data Telkomsel - Rekening Dormant\\01.png')

Mobile.tap(findTestObject('Object Repository/Topup/Paket Data/Telkomsel/01-button-topup'), 0)

Mobile.delay(1)
Mobile.takeScreenshot('C:\\Users\\H23070017\\Katalon Studio\\Msmile Revamp\\Screenshot\\N-TC-TOPUP - Paket Data Telkomsel - Rekening Dormant\\02.png')

Mobile.tap(findTestObject('Object Repository/Topup/Paket Data/Telkomsel/02-button-paket data'), 0)

Mobile.delay(1)
Mobile.takeScreenshot('C:\\Users\\H23070017\\Katalon Studio\\Msmile Revamp\\Screenshot\\N-TC-TOPUP - Paket Data Telkomsel - Rekening Dormant\\03.png')
...
Mobile.delay(1)
Mobile.takeScreenshot('C:\\Users\\H23070017\\Katalon Studio\\Msmile Revamp\\Screenshot\\N-TC-TOPUP - Paket Data Telkomsel - Rekening Dormant\\04.png')
...
Mobile.delay(1)
Mobile.takeScreenshot('C:\\Users\\H23070017\\Katalon Studio\\Msmile Revamp\\Screenshot\\N-TC-TOPUP - Paket Data Telkomsel - Rekening Dormant\\05.png')
...
Mobile.verifyElementText(findTestObject('Object Repository/Topup/Paket Data/Telkomsel/15-TextView-Error'), 'Error')

Mobile.verifyElementText(findTestObject('Object Repository/Topup/Paket Data/Telkomsel/15-TextView-message error'), 'Nomor rekening tujuan tidak ditemukan/rekening sumber dana Anda tidak aktif. Untuk aktivasi rekening sumber dana, lakukan pada menu Pengaturan Atur Akun, dengan nonaktifkan dan aktifkan kembali sebagai sumber dana lalu lakukan transaksi atas rekening tersebut. [F77]')

Mobile.delay(1)
Mobile.takeScreenshot('C:\\Users\\H23070017\\Katalon Studio\\Msmile Revamp\\Screenshot\\N-TC-TOPUP - Paket Data Telkomsel - Rekening Dormant\\06.png')

Mobile.delay(2)

Mobile.tap(findTestObject('Object Repository/Topup/Paket Data/Telkomsel/15-ViewGroup-button ok'), 0)
