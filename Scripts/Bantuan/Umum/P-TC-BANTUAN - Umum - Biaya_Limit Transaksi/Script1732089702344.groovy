...
Mobile.tap(findTestObject('Object Repository/Bantuan/Umum/Biaya - Limit Transaksi/005.TextView - Answer Biaya_Limit 1'), 0)

Mobile.delay(1, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot()

Mobile.tap(findTestObject('Bantuan/Umum/Biaya - Limit Transaksi/006.ViewGroup - Kembali'), 0)

Mobile.delay(1, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot()

Mobile.tap(findTestObject('Bantuan/Umum/Biaya - Limit Transaksi/007.ViewGroup - Kembali'), 0)
