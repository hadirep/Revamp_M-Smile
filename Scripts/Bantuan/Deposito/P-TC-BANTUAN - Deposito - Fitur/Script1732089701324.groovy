...
Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC-BANTUAN - Deposito - Fitur\\01.png')

Mobile.tap(findTestObject('Object Repository/Bantuan/Deposito/Fitur/02.RectView - Deposito'), 0)

Mobile.delay(1, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC-BANTUAN - Deposito - Fitur\\02.png')

Mobile.tap(findTestObject('Bantuan/Deposito/Informasi/03.PathView - Close Session'), 0)

Mobile.tap(findTestObject('Bantuan/Deposito/Penempatan dana/04.TextView - Penempatan Dana'), 0)

Mobile.delay(1, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC-BANTUAN - Deposito - Fitur\\03.png')

Mobile.tap(findTestObject('Bantuan/Deposito/Penempatan dana/05.TextView - Question Penempatan Dana 1'), 0)

Mobile.tap(findTestObject('Bantuan/Deposito/Penempatan dana/05.TextView - Answer Penempatan Dana 1'), 0)
...
Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC-BANTUAN - Deposito - Fitur\\06.png')
