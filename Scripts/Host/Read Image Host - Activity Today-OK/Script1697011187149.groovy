...
String executable = 'C://Program Files//Python312//python.exe'

//path project python
String pyscript = 'readimage - ActivityToday.py'
...
try {
    ...
    results.forEach({ def line ->
            ...
            if (line.contains('Transaction code')) {
                println('yes')
                GlobalVariable.TransactionCode = line
            } else {
                println('no')
            }
        })
