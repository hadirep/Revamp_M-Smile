...
if	(Windows.verifyElementPresent(findWindowsObject('Object Repository/Host/Button(1)'), 5, FailureHandling.OPTIONAL)){
	
	Windows.click(findWindowsObject('Object Repository/Host/Button(1)'))
	Windows.delay(5)
}
else {
	Windows.delay(5)
...
Windows.sendKeys(findWindowsObject('Object Repository/Host/Pane'), Keys.chord(Keys.CONTROL))
...
Windows.sendKeys(findWindowsObject('Object Repository/Host/Pane'), Keys.chord(GlobalVariable.rekMega))
...
if	(Windows.verifyElementPresent(findWindowsObject('Object Repository/Host/No Trx found Text'), 5, FailureHandling.OPTIONAL)){
	
	Windows.closeApplication()
}
else {

Windows.sendKeys(findWindowsObject('Object Repository/Host/Pane'), Keys.chord('1'))
...
Windows.callTestCase(findTestCase('Test Cases/Host/Read Image Host - Activity Today-OK'), null)
...
Windows.sendKeys(findWindowsObject('Object Repository/Host/Pane'), Keys.chord(Keys.F3))

Windows.sendKeys(findWindowsObject('Object Repository/Host/Pane'), Keys.chord(Keys.F3))

Windows.sendKeys(findWindowsObject('Object Repository/Host/Pane'), Keys.chord(Keys.F12))

Windows.sendKeys(findWindowsObject('Object Repository/Host/Pane'), Keys.chord('13'))
...
Windows.sendKeys(findWindowsObject('Object Repository/Host/Pane'), Keys.chord(trancode+trancode))

Windows.sendKeys(findWindowsObject('Object Repository/Host/Pane'), Keys.chord(Keys.ENTER))
Windows.delay(1)

Windows.sendKeys(findWindowsObject('Object Repository/Host/Pane'), Keys.chord(Keys.SHIFT+Keys.TAB))
Windows.delay(1)

//JIKA ADA LEBIH DARI 1 BARIS TELLER LOG :
Windows.sendKeys(findWindowsObject('Object Repository/Host/Pane'), Keys.chord(Keys.ARROW_UP))
Windows.delay(1)

Windows.sendKeys(findWindowsObject('Object Repository/Host/Pane'), Keys.chord('1'+'1'))
Windows.delay(1)
...
//Windows.sendKeys(findWindowsObject('Object Repository/Host/Pane'), Keys.chord(Keys.ENTER))
//Windows.delay(1)
if	(Windows.verifyElementPresent(findWindowsObject('Object Repository/Host/Text-Cursor in protected area of display'), 5, FailureHandling.OPTIONAL)){
