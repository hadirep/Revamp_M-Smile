...
Mobile.tap(findTestObject('Object Repository/Lihat Semua/Bayar/06. Bayar - E-Commerce/04. EditText-Daftar Produk'), 0)

Mobile.verifyElementText(findTestObject('Object Repository/Lihat Semua/Bayar/06. Bayar - E-Commerce/05. TextView-verif TOKOPEDIA'), 
	'TOKOPEDIA')
