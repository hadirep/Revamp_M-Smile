...
Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC-LIHAT SEMUA - Dana\\01.png')

Mobile.tap(findTestObject('Object Repository/Lihat Semua/Topup/Dana/02.ViewGroup - Dana'), 0)

Mobile.delay(1, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC-LIHAT SEMUA - Dana\\02.png')
...
Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC-LIHAT SEMUA - Dana\\03.png')
...
Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC-LIHAT SEMUA - Dana\\04.png')

Mobile.tap(findTestObject('Object Repository/Lihat Semua/Topup/Dana/10.ViewGroup - Back to Input nomor'), 0)

Mobile.delay(1, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC-LIHAT SEMUA - Dana\\05.png')

Mobile.tap(findTestObject('Object Repository/Lihat Semua/Topup/Dana/11.ViewGroup - Back to lihat semua'), 0)

Mobile.delay(1, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC-LIHAT SEMUA - Dana\\06.png')

Mobile.tap(findTestObject('Object Repository/Lihat Semua/Topup/Dana/12.ViewGroup - Back to Menu utama'), 0)

Mobile.delay(1, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC-LIHAT SEMUA - Dana\\07.png')

Mobile.pressBack()

Mobile.delay(1, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC-LIHAT SEMUA - Dana\\08.png')
