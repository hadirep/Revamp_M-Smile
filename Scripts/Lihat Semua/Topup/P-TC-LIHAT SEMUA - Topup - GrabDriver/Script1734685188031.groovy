...
Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC-LIHAT SEMUA - GrabDriver\\01.png')

Mobile.tap(findTestObject('Object Repository/Lihat Semua/Topup/Grab Driver/02.ViewGroup - Grabdriver'), 0)

Mobile.delay(1, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC-LIHAT SEMUA - GrabDriver\\02.png')
...
Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC-LIHAT SEMUA - GrabDriver\\03.png')
...
Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC-LIHAT SEMUA - GrabDriver\\04.png')

Mobile.tap(findTestObject('Object Repository/Lihat Semua/Topup/Grab Driver/10.ViewGroup - Back to input nomor'), 0)

Mobile.delay(1, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC-LIHAT SEMUA - GrabDriver\\05.png')

Mobile.tap(findTestObject('Object Repository/Lihat Semua/Topup/Grab Driver/11.ViewGroup - Back to lihat semua'), 0)

Mobile.delay(1, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC-LIHAT SEMUA - GrabDriver\\06.png')

Mobile.tap(findTestObject('Object Repository/Lihat Semua/Topup/Grab Driver/12.ViewGroup - Backto menu utama'), 0)

Mobile.delay(1, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC-LIHAT SEMUA - GrabDriver\\07.png')

Mobile.pressBack()

Mobile.delay(1, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC-LIHAT SEMUA - GrabDriver\\08.png')
