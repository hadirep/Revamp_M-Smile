...
Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC- Tarik Tunai - Rp. 200.000\\01.png')

Mobile.tap(findTestObject('Tarik Tunai/02.TextView - Rp. 200.000'), 0)

Mobile.delay(1, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC- Tarik Tunai - Rp. 200.000\\02.png')

Mobile.tap(findTestObject('Object Repository/Tarik Tunai/03.EditText - M-PIN'), 0)

Mobile.delay(1, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC- Tarik Tunai - Rp. 200.000\\03.png')

Mobile.setText(findTestObject('Object Repository/Tarik Tunai/04.EditText - Set M-PIN'), '111111', 0)

Mobile.delay(1, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC- Tarik Tunai - Rp. 200.000\\04.png')

Mobile.tap(findTestObject('Object Repository/Tarik Tunai/05.ScrollView - Close Keyboard'), 0)

Mobile.delay(1, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC- Tarik Tunai - Rp. 200.000\\05.png')
...
Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC- Tarik Tunai - Rp. 200.000\\06.png')

Mobile.tap(findTestObject('Object Repository/Tarik Tunai/08.TextView - OK'), 0)

Mobile.delay(1, FailureHandling.STOP_ON_FAILURE)

Mobile.takeScreenshot('D:\\Revamp_M-Smile\\Screenshoot\\P-TC- Tarik Tunai - Rp. 200.000\\07.png')
